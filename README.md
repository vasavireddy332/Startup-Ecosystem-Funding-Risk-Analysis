...
🔎 Data Quality	0 duplicate rows, 0 missing dates, 0 missing cleaned cities, 0 missing cleaned industries after cleaning
💡 Business Insights
Bengaluru was the leading city by number of funding records.
Consumer Internet was the most frequently funded sector by number of records.
Startup funding experienced significant year-to-year fluctuations.
2017 was a particularly strong year for funding growth.
Funding activity declined sharply in 2020 in the available dataset.
Startup funding was concentrated among major cities.
Consumer Internet, Technology, and E-Commerce were major sectors by number of funding records.
Funding amounts varied substantially between individual deals.
Data cleaning significantly improved the consistency of city and sector analysis.
Converting investment amounts to numeric values enabled reliable financial calculations.
🚀 Future Improvements
Complete analysis of all 3,044 records in the SQL/Power BI pipeline
Investor-level analysis
Top investor rankings
Startup-level funding rankings
...
Real-time or regularly updated startup funding data
📦 Project Deliverables
Startup_Ecosystem_Dashboard.pbix
dashboard_screenshots.pdf
startup_funding_cleaned_final.csv
...
Executive Overview                  City & Sector Intelligence         Risk & Volatility Monitoring
    ↓                                    ↓                                  ↓
Total Funding                       Funding by City                    Volatility Trend
Total Deals                         Funding by Sector                  Sector Stability
Average Deal Size                   YoY Growth                         Data Completeness
Yearly Funding Trend
🎓 Skills Demonstrated

Python · Pandas · Data Cleaning · Data Preprocessing · Data Validation · Exploratory Data Analysis · SQL · MySQL · MySQL Workbench · Aggregate Functions · Window Functions · Year-over-Year Analysis · Statistical Analysis · DAX · Power BI · Data Visualization · Dashboard Design · Business Intelligence · Data Storytelling
...
The project converts raw and inconsistent startup funding data into a structured analytical solution that can be used to understand funding trends, startup hubs, sector activity, investment sizes, volatility, and data quality.

👩‍💻 Author

Vasavi Reddy B.Tech Student | Aspiring Data Analyst

Areas of Interest: Data Analytics · Python · SQL · Power BI · Data Visualization · Prompt Engineering

⭐ Project Summary

Startup Ecosystem Funding & Risk Analysis is an end-to-end analytics project that demonstrates how raw business data can be transformed into meaningful insights using:

Python → SQL → Power BI

The project combines technical data-processing skills with business-oriented analysis and visualization to understand the Indian startup funding ecosystem.
